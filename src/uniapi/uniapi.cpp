...
UniAPI::UniAPI(const string& user, const string& password, const string& host, int port)
...
Value UniAPI::sendcommand(const string& command, const Value& params){    
    Value result;
    ...
    try{
		...
		UniException err(e.GetCode(), e.GetMessage());
		throw err;
	}
...
string UniAPI::IntegerToString(int num){
	std::ostringstream ss;
	ss << num;
	return ss.str();
}

double UniAPI::RoundDouble(double num)
{
	return num;
}
...
/* === Node functions === */
void UniAPI::addnode(const string& node, const string& comm) {
...
vector<nodeinfo_t> UniAPI::getaddednodeinfo(bool dns) {
...
vector<nodeinfo_t> UniAPI::getaddednodeinfo(bool dns, const std::string& node) {
	string command = "getaddednodeinfo";
	Value params, result;
	vector<nodeinfo_t> ret;
...
vector<peerinfo_t> UniAPI::getpeerinfo() {
...
/* === Wallet functions === */
void UniAPI::backupwallet(const string& destination) {
...
string UniAPI::encryptwallet(const string& passphrase) {
...
void UniAPI::walletlock() {
	string command = "walletlock";
	Value params;
	sendcommand(command, params);
}

void UniAPI::walletpassphrase(const string& passphrase, int timeout) {
...
void UniAPI::walletpassphrasechange(const string& oldpassphrase, const string& newpassphrase) {
...
string UniAPI::dumpprivkey(const string& uniaddress) {
	string command = "dumpprivkey";
	Value params, result;
	params.append(uniaddress);
	result = sendcommand(command, params);
	return result.asString();
}

void UniAPI::importprivkey(const string& uniprivkey) {
	string command = "importprivkey";
	Value params;
	params.append(uniprivkey);
	sendcommand(command, params);
}

void UniAPI::importprivkey(const string& uniprivkey, const string& label, bool rescan) {
	string command = "importprivkey";
	Value params;
	params.append(uniprivkey);
	params.append(label);
...
string UniAPI::addmultisigaddress(int nrequired, const vector<string>& keys) {
...
string UniAPI::addmultisigaddress(int nrequired, const vector<string>& keys, const string& account) {
	string command = "addmultisigaddress";
	Value params, result;
	params.append(nrequired);
...
multisig_t UniAPI::createmultisig(int nrequired, const vector<string>& keys) {
...
string UniAPI::getnewaddress(const string& account) {
...
validateaddress_t UniAPI::validateaddress(const string& uniaddress) {
...
void UniAPI::keypoolrefill() {
	string command = "keypoolrefill";
	Value params;
	sendcommand(command, params);
}

bool UniAPI::settxfee(double amount) {
...
double UniAPI::estimatefee(int blocks) {
...
string UniAPI::signmessage(const std::string& uniaddress, const std::string& message) {
...
bool UniAPI::verifymessage(const std::string& uniaddress, const std::string& signature, const std::string& message) {
...
double UniAPI::getbalance(const string& account, int minconf) {
	string command = "getbalance";
	Value params, result;
	params.append(account);
...
double UniAPI::getunconfirmedbalance() {
...
double UniAPI::getreceivedbyaccount(const string& account, int minconf) {
...
double UniAPI::getreceivedbyaddress(const string& uniaddress, int minconf) {
...
vector<accountinfo_t> UniAPI::listreceivedbyaccount(int minconf, bool includeempty) {
...
vector<addressinfo_t> UniAPI::listreceivedbyaddress(int minconf, bool includeempty) {
...
gettransaction_t UniAPI::gettransaction(const string& tx, bool watch) {
...
vector<transactioninfo_t> UniAPI::listtransactions() {
...
vector<transactioninfo_t> UniAPI::listtransactions(const string& account, int count, int from) {
	string command = "listtransactions";
	Value params, result;
	vector<transactioninfo_t> ret;
...
string UniAPI::getaccount(const string& uniaddress) {
...
string UniAPI::getaccountaddress(const string& account) {
...
vector<std::string> UniAPI::getaddressesbyaccount(const string& account) {
...
map<string, double> UniAPI::listaccounts(int minconf) {
...
vector< vector<addressgrouping_t> > UniAPI::listaddressgroupings() {
...
bool UniAPI::move(const string& fromaccount, const string& toaccount, double amount, int minconf) {
	string command = "move";
	Value params, result;
...
bool UniAPI::move(const string& fromaccount, const string& toaccount, double amount, const string& comment, int minconf) {
	string command = "move";
	Value params, result;
...
void UniAPI::setaccount(const string& uniaddress, const string& account){
...
string UniAPI::sendtoaddress(const string& uniaddress, double amount) {
...
string UniAPI::sendtoaddress(const string& uniaddress, double amount, const string& comment, const string& comment_to) {
	string command = "sendtoaddress";
	Value params, result;
...
string UniAPI::sendfrom(const string& fromaccount, const string& touniaddress, double amount) {
	string command = "sendfrom";
	Value params, result;

	params.append(fromaccount);
	params.append(touniaddress);
	params.append(RoundDouble(amount));
...
string UniAPI::sendfrom(const string& fromaccount, const string& touniaddress, double amount, const string& comment, const string& comment_to, int minconf) {
	string command = "sendfrom";
	Value params, result;
...
string UniAPI::sendmany(const string& fromaccount, const map<string,double>& amounts) {
...
string UniAPI::sendmany(const string& fromaccount, const map<string,double>& amounts, const string comment, int minconf) {
	string command = "sendmany";
	Value params, result;
...
vector<unspenttxout_t> UniAPI::listunspent(int minconf, int maxconf) {
...
vector<txout_t> UniAPI::listlockunspent() {
...
bool UniAPI::lockunspent(bool unlock, const vector<txout_t>& outputs) {
...
/* === Mining functions === */
string UniAPI::getbestblockhash() {
...
string UniAPI::getblockhash(int blocknumber) {
...
blockinfo_t UniAPI::getblock(const string& blockhash) {
...
void UniAPI::setgenerate(bool generate, int genproclimit) {
...
mininginfo_t UniAPI::getmininginfo() {
...
txsinceblock_t UniAPI::listsinceblock(const string& blockhash, int target_confirmations) {
...
getrawtransaction_t UniAPI::getrawtransaction(const string& txid, int verbose) {
...
decodescript_t UniAPI::decodescript(const std::string& hexString) {
...
decoderawtransaction_t UniAPI::decoderawtransaction(const string& hexString) {
...
string UniAPI::sendrawtransaction(const string& hexString, bool highFee) {
...
string UniAPI::createrawtransaction(const vector<txout_t>& inputs, const map<string,double>& amounts) {
...
string UniAPI::createrawtransaction(const vector<txout_t>& inputs, const map<string,string>& amounts) {
	string command = "createrawtransaction";
	Value params, result;
...
signrawtransaction_t UniAPI::signrawtransaction(const string& rawTx, const vector<signrawtxin_t> inputs) {
...
signrawtransaction_t UniAPI::signrawtransaction(const string& rawTx, const vector<signrawtxin_t> inputs, const vector<string>& privkeys, const string& sighashtype) {
	string command = "signrawtransaction";
	Value params, result;
	signrawtransaction_t ret;
...
vector<string> UniAPI::getrawmempool() {
...
string UniAPI::getrawchangeaddress() {
...
utxoinfo_t UniAPI::gettxout(const std::string& txid, int n, bool includemempool) {
...
utxosetinfo_t UniAPI::gettxoutsetinfo() {
